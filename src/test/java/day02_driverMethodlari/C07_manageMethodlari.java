...
public class C07_manageMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
            maximize() -->tam ekran
            minimize() -->görev çubuğuna indirir
            fullscreen() -->çerçeve kalmayacak şekilde büyütüyor
            getPosition() -->driver koordinatlarını verir
            getSize() -->driver ölçülerini getirir.
         */
    }
}