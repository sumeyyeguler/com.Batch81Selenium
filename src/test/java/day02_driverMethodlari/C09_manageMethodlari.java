...
public class C09_manageMethodlari {
    public static void main(String[] args) {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));//15 sn de açılmazsa hata alırız
        ...
        driver.close();//sadece calısan browseri kapatır
       // driver.quit(); tüm sekmelerler birlikte kapatır.
